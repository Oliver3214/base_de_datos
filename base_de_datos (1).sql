...
CREATE TABLE `clientes` (
  ...
  CONSTRAINT `idCliente_ventas_clientes` FOREIGN KEY (`idClientes`) REFERENCES `ventas` (`idVenta`)
...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `idProveedores_proveedores_compra` FOREIGN KEY (`idproveedor`) REFERENCES `proveedores` (`idProveedore`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `empleados` (
  ...
  CONSTRAINT `idempleado_ventas_empleados` FOREIGN KEY (`idEmpleados`) REFERENCES `ventas` (`idVenta`),
  CONSTRAINT `idPuesto_puestos_empleados` FOREIGN KEY (`idPuesto`) REFERENCES `puestos` (`idPuestos`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `productos` (
  ...
  KEY `idMarca_productos_marca_idx` (`idMarca`),
  CONSTRAINT `idMarca_productos_marca` FOREIGN KEY (`idMarca`) REFERENCES `marcas` (`idMarca`),
  CONSTRAINT `idProducto_compra_detalle` FOREIGN KEY (`idProductos`) REFERENCES `compras_detalle` (`idproducto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ventas_detalle` (
  ...
  KEY `idProducto_productos_venta_detalle_idx` (`idProducto`),
  CONSTRAINT `idProducto_productos_venta_detalle` FOREIGN KEY (`idProducto`) REFERENCES `productos` (`idProductos`),
  CONSTRAINT `idVenta_ventas_detalle_ventas` FOREIGN KEY (`idVenta`) REFERENCES `ventas` (`idVenta`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-10-02 11:41:54
